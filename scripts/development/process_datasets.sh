...
# cdo -f nc remapcon,/Users/marco/Documents/dati/obs/GPCPv2_3/griddes.txt $dir_obs/camsopi_timecorrect.nc $dir_obs/camsopi_timecorrect-2.5.nc 
...
# dir_obs="/Users/marco/Documents/dati/obs/CHIRPS"
...
# cdo -f nc remapcon,/Users/marco/Documents/dati/obs/GPCPv2_3/griddes.txt $dir_obs/chirps-v2.0.monthly.nc $dir_obs/chirps-v2.0.monthly-2.5.nc 
# cdo -f nc remapcon,/Users/marco/Documents/dati/obs/GPCPv2_3/griddes.txt $dir_obs/chirps-v2.0.$py.$pm0.nc $dir_obs/chirps-v2.0.$py.$pm0-2.5.nc
...
# dir_obs=/Users/marco/Documents/dati/obs/CPC_GLOBAL_PRECIP
# cd $dir_obs
# rm precip_1981_2020_monthly.nc
# cdo cat *.nc ofile.nc
# cdo monsum ofile.nc ofile_monthly.nc
# cdo -f nc remapcon,/Users/marco/Documents/dati/obs/GPCPv2_3/griddes.txt ofile_monthly.nc ofile_monthly_25.nc
# mv ofile_monthly_25.nc precip_1981_2020_monthly.nc
# rm ofile*.nc


### ERA5
# INDIR="/Users/marco/Documents/dati/obs/ERA5/"
# OUTDIR="/Users/marco/Documents/dati/obs/ERA5/"
# cd $INDIR
# rm ERA5-drop.nc
# for iyear in {1981..2020}
# do
# for imonth in {01..12}
# do
...
#  name=$(basename $f .nc)
#  cdo -f nc remapcon,/Users/marco/Documents/dati/obs/GPCPv2_3/griddes.txt $f $name-drop.nc
#  cdo cat $name-drop.nc ERA5-drop.nc
# done
# done

#cdo -f nc remapcon,/Users/marco/Documents/dati/obs/GPCPv2_3/griddes.txt prec-era5-$pm-$py.nc prec-era5-$pm0-$py-drop.nc
#cdo cat prec-era5-$pm0-$py-drop.nc ERA5-drop.nc

## GPCC
## dir_obs=/data/disk1/GPCCv2018
# dir_obs=/Users/marco/Documents/dati/obs/GPCCv2018
# cd $dir_obs
##cdo -f nc remapcon,/data/disk1/GPCPv2_3/griddes.txt full_data_monthly_v2018_10.nc full_data_monthly_v2018_25.nc
# cdo -f nc remapcon,/Users/marco/Documents/dati/obs/GPCPv2_3/griddes.txt full_data_monthly_v2018_25.nc full_data_monthly_v2018_25_2.nc
# mv full_data_monthly_v2018_25_2.nc full_data_monthly_v2018_25.nc
...
# cdo -f nc remapcon,/Users/marco/Documents/dati/obs/GPCPv2_3/griddes.txt ofile222.nc ofile2222.nc
# cdo cat ofile11.nc ofile2222.nc prec_1981_$py.nc
# rm ofile*

## GPCP
# dir_obs=/data/disk1/GPCPv2_3
# dir_obs=/Users/marco/Documents/dati/obs/GPCPv2_3
# cd $dir_obs
...
## JRA55
# cd /Users/marco/Documents/dati/obs/JRA55
# rm JRA55_1981_2019_25_monthly.nc
# cdo cat *.nc ofile.nc
# cdo -f nc remapcon,/Users/marco/Documents/dati/obs/GPCPv2_3/griddes.txt ofile.nc ofile2.nc
...
# cdo -f nc remapcon,/Users/marco/Documents/dati/obs/GPCPv2_3/griddes.txt "prate_1981_"$py".nc" "prate_1981_"$py"_monthly.nc"
#cdo -f nc remapcon,/data/disk1/GPCPv2_3/griddes.txt "prate_1981_"$py".nc" "prate_1981_"$py"_monthly.nc"


## PREC/L
#dir_obs=/data/disk1/PRECL
# dir_obs=/Users/marco/Documents/dati/obs/PRECL
# cd $dir_obs
...
# cdo -f nc remapcon,/Users/marco/Documents/dati/obs/GPCPv2_3/griddes.txt ofile2.nc "precip.mon.mean.2.5x2.5.1981_"$py".nc"
# rm ofile*
