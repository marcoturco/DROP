...
#cdo selyear,1981/2019 $dir_obs/camsopi_timecorrect-2.5.nc $dir_obs/#camsopi_timecorrect-2.5-1981-2019.nc 
...
# cdo -f nc remapcon,/data/disk1/GPCPv2_3/griddes.txt $dir_obs/chirps-v2.0.2019.$pm0.nc $dir_obs/chirps-v2.0.2019.$pm0-2.5.nc
#cdo cat $dir_obs/chirps-v2.0.monthly-2.5.nc $dir_obs/chirps-v2.0.2019.$pm0-2.5.nc $dir_obs/ofile.nc
...
#cdo -f nc remapcon,/data/disk1/GPCPv2_3/griddes.txt ofile_monthly.nc precip_1981_2019_monthly.nc
#rm ofile.nc
...
##done
##done
#cdo -f nc remapcon,/data/disk1/GPCPv2_3/griddes.txt prec-era5-$pm0-2019.nc prec-era5-$pm0-2019-drop.nc
#cdo cat prec-era5-$pm0-2019-drop.nc ERA5-drop.nc
...
#  cdo cat first_guess_monthly_2017_* first_guess_monthly_2018_* first_guess_monthly_2019_* ofile2.nc 
...
#  cdo cat ofile11.nc ofile2222.nc prec_1981_2019.nc
#  rm ofile*
...
# cdo selyear,1981/2019 ofile1.nc ofile2.nc
# cdo muldpm ofile2.nc gpcp_cdr_v23rB1_1981_2019.nc
# rm ofile*
...
#cdo muldpm ofile2.nc JRA55_1981_2019_25_monthly.nc
#rm ofile*
...
# cdo cat *.nc ofile.nc
# cdo selyear,1981/2019 ofile.nc ofile2.nc
...
# cdo mulc,86400 ofile5.nc MERRA2_1981_2019_25_monthly.nc
# rm ofile*

## NCEP
# cd /data/disk1/NCEP
# cdo selyear,1981/2019 prate.sfc.mon.mean.nc prate_1981_2019.nc
# cdo -f nc remapcon,/data/disk1/GPCPv2_3/griddes.txt prate_1981_2019.nc precip_1981_2019_monthly.nc


## PREC/L
# dir_obs=/data/disk1/PRECL
# cd $dir_obs
# cdo selyear,1981/2019 precip.mon.mean.2.5x2.5.nc ofile1.nc
# cdo muldpm ofile1.nc ofile2.nc
# cdo -f nc remapcon,/data/disk1/GPCPv2_3/griddes.txt ofile2.nc precip.mon.mean.2.5x2.5.1981_2019.nc
# rm ofile*
